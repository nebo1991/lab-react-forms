...
function App() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const newStudent = { fullName, image, phone, email, program, gradYear, graduated };
    ...
    <div className="App pt-20">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <label>
            Profile Image
            <input name="image" type="url" placeholder="Profile Image" value={image} onChange={handleProfileImage} />
          </label>
